...
const dataExperience = [
  {
    ...
    info: (
      <React.Fragment>
        ...
        находится часть работ <a href="https://lapkov.com/ru/works/">lapkov.com/ru/works</a>, в основном это небольшие сайты, интернет-магазины,
        в которых я принимал участие как фрилансер.
      </React.Fragment>
    ),
  },
  {
    period: `Авг 2018 - Сен 2020.`,
