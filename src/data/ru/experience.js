  ...
  experience: [
    {
      ...
      info: (
        <React.Fragment>
          ...
          Сейчас я активно изучаю все, что связано с JavaScript и всей современной сетью. На странице проектов
    ...
    {
      period: `Окт 2018 - Сен 2020`,
      position: `Начинающий веб-разработчик`,
    ...
    },
    {
      ...
      siteUrl: ``,
      siteName: ``,
      info: `Первая работа в IT в моей жизни. Работал удаленно SEO-специалистом в туристической компании
      Hipway и ее смежном продукте Hipclub. Здесь я вырос из рядового сотрудника до начальника SEO отдела.`,
    },
  ]
}
