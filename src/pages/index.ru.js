...
const IndexPage = ({ location }) => (
  <Layout location={location} defaultLang="ru">
    <Seo
      location={location}
      title="Я веб-разработчик и SEO-специалист | А. Лапков"
      description="Меня зовут Александр Лапков. Я являюсь веб-разработчиком (преимущественно фронтенд) и SEO-специалистом.
        Занимаюсь созданием современных и прогрессивных веб-сайтов для небольших компаний,
        организаций и стартапов."
    />
    <Image />
    <h1 style={{ height: "130px", textAlign: "center" }}>
      <span style={{ display: "none" }}>
        Я Александр. Веб-разработчик, SEO.
      </span>
      <TypedReact
        strings={[
          "Я – Александр. <br />Веб-разработчик, <br />SEO специалист",
        ]}
      />
    </h1>
    <h2>Обо мне</h2>
    <blockquote>
      <p>
        Меня зовут <strong>Александр Лапков</strong>. Я фронтенд, веб-разработчик и SEO-специалист. Мне нравится создавать
