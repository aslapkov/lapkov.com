...
const IndexPage = () => (
  <Layout>
    <Seo
      ...
      description="Меня зовут Александр. Я фронтенд-разработчик и UX/UI дизайнер.
    ...
    <blockquote>
      <p>
        Меня зовут Александр. Я фронтенд, веб-разработчик и UX/UI дизайнер. Мне нравится создавать
